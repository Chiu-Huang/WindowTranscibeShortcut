...
class Translator:
    ...
    def should_translate(self, texts: Sequence[str], hinted_language: str | None = None) -> bool:
        source = self.detect_source_language(texts, hinted_language)
