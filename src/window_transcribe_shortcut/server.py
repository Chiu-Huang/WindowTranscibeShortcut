...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description='Run the Window Transcribe Shortcut FastAPI backend.')
...
def main() -> int:
    ...
    if args.warmup:
        ...
        logger.info('Preloading WhisperX model before server start')
